...
public class TransactionFormFragment extends Fragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
                ...
                if (mSplitsList.size() == 2) {
                    ...
                    for (Split split : mSplitsList) {
                        if (!split.getAccountUID().equals(mAccountUID)) {
                            ...
                            AccountUtils.setAccountTextColor(accountFullNameTextView, accountUID);
                        }
        ...
        KeyboardUtils.hideKeyboard(mDescriptionEditText, 200);
    ...
    private void initTransactionNameAutocomplete() {
        ...
        adapter.setFilterQueryProvider(name ->
                mTransactionsDbAdapter.fetchTransactionSuggestions(name == null ? "" : name.toString(), mAccountUID));
        ...
        mDescriptionEditText.setOnItemClickListener((adapterView, view, position, id) -> {
            ...
            if (isSplitPair) {
                mSplitsList.clear();
                if (!amountEntered) {
                    //if user already entered an amount
    ...
    private void updateTransferAccountsList() {
        ...
        mAccountCursorAdapter = new QualifiedAccountNameCursorAdapter(
                getActivity(),
                mCursor,
                where,
                null,
     ...
     */
    private @NonNull
    Transaction extractTransactionFromView() {
