...
public class BulkMoveDialogFragment extends DialogFragment {
    ...
    /**
     * Dialog positive button. Move the transactions.
     */
    Button mOkButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.dialog_bulk_move, container, false);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NORMAL, R.style.Theme_GnucashTheme_Dialog);
    }
